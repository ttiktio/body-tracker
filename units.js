...
(function(){
  ...
  function updateGuide(part){
    ...
    $('bodyGuideCanvas').dataset.part=selectedGuide;
    $('bodyGuideCanvas').dataset.sex=settings.sex;
  ...
  function applyLanguage(){
    ...
    $('bodyGuideCanvas').setAttribute('aria-label',t('canvasLabel'));
    document.querySelector('.view-controls').setAttribute('aria-label',t('viewControls'));
  ...
  document.querySelectorAll('[data-show-guide]').forEach(btn=>btn.addEventListener('click',()=>{updateGuide(btn.dataset.showGuide);$('bodyGuideCanvas')?.scrollIntoView({behavior:matchMedia('(prefers-reduced-motion: reduce)').matches?'instant':'smooth',block:'center'})}));
